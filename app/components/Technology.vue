<template>
  ...
  >
    <img
      class="mx-auto max-w-[150px] md:max-w-[unset]"
      src="/assets/images/venomphpr.svg"
      alt=""
    />
    <h2
      class="text-title md:text-title-md lg:text-title-lg xl:text-title-xl font-bold text-center mb-12 mt-[5%] md:mt-[10%] leading-[120%]"
    >
